...
| 3 API P95 | −20% on ≥2 endpoints | `/api/auth/me` 93.7/127.4 ms; `/api/projects` 106.6/236.2 ms | auth/me 34.9–49.7 / 70.5–92.8 ms; projects 66.5–73.7 / 173.0–180.2 ms | auth/me **−47..−63% / −27..−45%**; projects **−31..−38% / −24..−27%** (each verified in two runs) | `bench/cat3-latency/out/` + `NOTES-2026-07-29.md` | ✅ met on 2 endpoints (2026-07-30: /api/projects grouped-join rewrite — the diagnosis correctly identified it as the one DB-bound endpoint; earlier attempts + diagnosis preserved in the notes) |
