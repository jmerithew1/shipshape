    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex items-center justify-between border-b border-border px-6 py-4">
        <div className="flex items-center gap-2.5">
          ...
          {/* accent-bright: plain accent text on the tinted chip is ~2.6:1 (axe serious, Cat 7) */}
          {week.is_current && (
          ...
          <div className="space-y-1.5">
            {standups.map((slot: StandupSlot) => {
              ...
              const rowClass = cn(
                ...
                // Dashed border, not opacity-40: row-level opacity dragged every
                // piece of text in future rows below the 4.5:1 minimum (axe
                // serious, Cat 7); a dashed border de-emphasizes without
